...
builder.Services.AddDbContext<ClassSourceContext>(options => options.UseSqlServer(x));
//options.UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);
builder.Services.AddIdentity<CoursesUser, IdentityRole>()
    .AddEntityFrameworkStores<ClassSourceContext>();
